...
def execute_excel_vba_macro_on_files_simple(update_info: Callable[[str], None] = None):
    """
    简化版批量执行Excel VBA宏导出到Word
    直接打开文件、添加宏、执行、关闭，每个文件独立处理
    """
    # 1. 选择多个Excel文件
